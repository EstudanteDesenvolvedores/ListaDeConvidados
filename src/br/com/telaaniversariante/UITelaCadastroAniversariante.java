 ...
 * @author Jean Heberth
 */
public class UITelaCadastroAniversariante extends javax.swing.JFrame {

    /**
     * Creates new form UITelaCadastroAniversariante
     */
    public UITelaCadastroAniversariante() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(808, 605));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UITelaCadastroAniversariante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UITelaCadastroAniversariante().setVisible(true);
            }
        });
    }
